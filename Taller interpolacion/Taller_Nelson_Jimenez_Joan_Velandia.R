...
#e
cat("\nTeniendo en cuenta ambos resultados, el teorico es mejor debido a que el resultado es logico (pues da entre el intervalo de [400,500]) y la grafica pasa por todos los puntos
    ademas el de poly_calc da un valor muy raro y la grafica solo pasa por un punto. Utilizando otro metodo
    de lagrange en Pracma el resultado es bastante similar al teorico. Por otro lado la cantidad de multiplicaciones
    en el teorico fueron 90 y en lagrange al ser un polinomio sacado de 6 puntos se requieren 6 ciclos y 
    por cada ciclo es necesario hacer 2n multiplicaciones (12) por lo que se realizan 72 multiplicaciones. 
